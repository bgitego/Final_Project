...
//#define nrf24l01_CE_IOREGISTER		nRF24L01_CE_GPIO_Port
//#define nrf24l01_CE_PINMASK			nRF24L01_CE_Pin

//defines for uC pins CSN pin is connected to
//This is used so that the routines can send properly operate the SPI interface
// on the nrf24l01.
//Change these definitions (and then recompile) to suit your particular application.
//#define nrf24l01_CSN_IOREGISTER		SPI1_CS_GPIO_Port
//#define nrf24l01_CSN_PINMASK		SPI1_CS_Pin

//defines for uC pins IRQ pin is connected to
//This is used so that the routines can poll for IRQ or create an ISR.
//Change these definitions (and then recompile) to suit your particular application.
#define nrf24l01_IRQ_IOREGISTER		nRF24L01_IRQ_GPIO_Port
#define nrf24l01_IRQ_PINMASK		nRF24L01_IRQ_Pin // Need to look into this as alternative #define nRF24L01_IRQ_EXTI_IRQn EXTI3_IRQn
