...
bool nrf24l01_ce_pin_active()
{
	...
	if((HAL_GPIO_ReadPin(nRF24L01_CE_GPIO_Port,nRF24L01_CE_Pin))!= 0)
		return true;
	else
		return false;
}
...
void nrf24l01_clear_csn()
{
	...
	HAL_GPIO_WritePin(nRF24L01_CS_GPIO_Port,nRF24L01_CS_Pin,GPIO_PIN_RESET);
}
...
{
	if((HAL_GPIO_ReadPin(nRF24L01_CS_GPIO_Port,nRF24L01_CS_Pin))!= 0)
		return true;
	else
		return false;	
}
...
{
	if((HAL_GPIO_ReadPin(nRF24L01_IRQ_GPIO_Port,nRF24L01_IRQ_Pin))!= 0)
		return false;
	else
		return true;
}
